...
<body>
        ...
        <div class="card-deck">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary addbtn" onclick="addToCart('All Out')">Add to Cart</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary addbtn" onclick="addToCart('Dove Shampoo')">Add to Cart</a>
                </div>
            </div>
            <div class="card">     
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary addbtn" onclick="addToCart('Loreal Cleanser')">Add to Cart</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary addbtn" onclick="addToCart('Crayons');">Add to Cart</a>
                </div>
            </div>  
        </div>
    </div>
    <script>
         /*$('.addbtn').click((e) => {
            ...
            name = e.currentTarget.parentElement.childNodes[8].innerText;
            
            $.post('addtocart.php',
                {p_name: name ,quantity: "1", price: 100, description:"abc"add_by_user: "saikat"},
